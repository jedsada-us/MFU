...
#ifndef LOGTASK_SERIALID
#define LOGTASK_SERIALID		1		/* システムログ用のシリアルポート番号 */
#endif /* LOGTASK_SERIALID */

#ifndef LOGTASK_IOCTLID
#define LOGTASK_IOCTLID		2		/* IO Control port number for system log */
#endif /* LOGTASK_IOCTLID */
