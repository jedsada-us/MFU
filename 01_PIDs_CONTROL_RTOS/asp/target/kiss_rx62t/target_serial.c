...
SIOPCB* sio_opn_por(ID siopid, intptr_t exinf)
{
	...
	p_siopcb = rx600_serial_opn_por(siopid, exinf, SERIAL_BAUDRATE, SERIAL_CLKSRC);
...
{
	return (rx600_serial_snd_chr(siopcb, c));
}
...
{
	return (rx600_serial_rcv_chr(siopcb));
}
...
{
	rx600_serial_ena_cbr(siopcb, cbrtn);
}
...
{
	rx600_serial_dis_cbr(siopcb, cbrtn);
}

/*
 *  シリアルI/Oポートからの送信可能コールバック
 */
void rx600_serial_irdy_snd(intptr_t exinf)
{
 ...
 */
void rx600_serial_irdy_rcv(intptr_t exinf)
{
