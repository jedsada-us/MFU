...
/*
 *		シリアルI/Oデバイス（SIO）ドライバ（KISS-RX62T用）
 */
 ...
 *  SIOの割込みハンドラのベクタ番号
 */
#define INHNO_SIO_TX   INT_SCI0_TEI /* 割込みハンドラ番号 */
#define INTNO_SIO_TX   INT_SCI0_TEI /* 割込み番号 */
#define INHNO_SIO_RX   INT_SCI0_RXI /* 割込みハンドラ番号 */
#define INTNO_SIO_RX   INT_SCI0_RXI /* 割込み番号 */
